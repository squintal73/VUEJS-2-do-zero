      ...
      <div class="row">
          <div class="col">
              <div class="form-group">
                  <input v-model='username' type='text' aria-label="username" class='form-control' placeholder='github username'>
              </div>
          </div>

          <div class="col">
              <div class="form-group">
                <input v-model='repository' type='text' aria-label="repository" class='form-control' placeholder='github repositório'>
              </div>
          </div>
